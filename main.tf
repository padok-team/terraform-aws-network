...
module "vpc" {
  ...
  map_public_ip_on_launch = var.map_public_ip_on_launch # default false

  public_dedicated_network_acl  = var.public_dedicated_network_acl  # default false
  private_dedicated_network_acl = var.private_dedicated_network_acl # default false
  intra_dedicated_network_acl   = var.intra_dedicated_network_acl   # default false
